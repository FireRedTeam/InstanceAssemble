...
import numpy as np
from ..layout import Layout, encode_layout_flux
...
def generate(
    ...
    **params: dict,
    ...
    if use_condition:
        layout_kwargs = encode_layout_flux(layout, self, (int(height) // self.vae_scale_factor // 2, int(width) // self.vae_scale_factor // 2))
